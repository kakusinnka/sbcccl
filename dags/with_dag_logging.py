...
with DAG(
    ...
    def task_start():
        logger.log_text('with_dag_logging' + ' DAG 开始')

    def task_001():
        logger.log_text('with_dag_logging' + ' TASK001 开始')
        print('调用 API')
        logger.log_text('with_dag_logging' + ' TASK001 结束')

    def task_end():
        logger.log_text('with_dag_logging' + ' DAG 结束')
