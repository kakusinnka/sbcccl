...
with DAG(
    ...
    def task_start():
        ...
        logging.info('with_dag_python_logging' + ' DAG 开始')

    def task_001():
        logging.info('with_dag_python_logging' + ' TASK001 开始')
        print('调用 API')
        logging.info('with_dag_python_logging' + ' TASK001 结束')

    def task_end():
        logging.info('with_dag_python_logging' + ' DAG 结束')
